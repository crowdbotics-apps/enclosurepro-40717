"""
Django settings for enclosurepro_40717 project.
...
ROOT_URLCONF = 'enclosurepro_40717.urls'
...
WSGI_APPLICATION = 'enclosurepro_40717.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "enclosurepro_40717 API",
    "DESCRIPTION": "API documentation for enclosurepro_40717 App",
    "VERSION": "v1",
}
